...
router.get('/', authorize('vendor:read'), list);
router.get('/:id', authorize('vendor:read'), get);
...
router.get('/:id/contacts', authorize('vendor:read'), listContacts);
...
router.get('/:id/contracts', authorize('vendor:read'), listContracts);
...
router.get('/:id/purchase-orders', authorize('vendor:read'), listPurchaseOrders);
