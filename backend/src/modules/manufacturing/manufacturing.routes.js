...
// Work Centers
router.get('/work-centers', authorize('manufacturing:read'), listWorkCenters);
router.get('/work-centers/:id', authorize('manufacturing:read'), getWorkCenter);
...
// BOM
router.get('/bom', authorize('manufacturing:read'), listBoms);
router.get('/bom/:id', authorize('manufacturing:read'), getBom);
router.get('/bom/:id/explode', authorize('manufacturing:read'), explodeBom);
...
// Work Orders
router.get('/work-orders', authorize('manufacturing:read'), listWorkOrders);
router.get('/work-orders/:id', authorize('manufacturing:read'), getWorkOrder);
