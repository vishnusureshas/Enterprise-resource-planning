export const ROUTES = {
  ...
  MANUFACTURING_BOM_DETAIL: (id: string) => `/manufacturing/bom/${id}`,
  MANUFACTURING_WORK_CENTERS: "/manufacturing/work-centers",
  MANUFACTURING_WORK_ORDERS: "/manufacturing/work-orders",
  MANUFACTURING_WORK_ORDER_DETAIL: (id: string) => `/manufacturing/work-orders/${id}`,
  MANUFACTURING_WORK_ORDER_NEW: "/manufacturing/work-orders/new",
  QUALITY: "/quality",
  QUALITY_CHECKLISTS: "/quality/checklists",
  QUALITY_CHECKLIST_DETAIL: (id: string) => `/quality/checklists/${id}`,
  QUALITY_INSPECTIONS: "/quality/inspections",
  QUALITY_INSPECTION_DETAIL: (id: string) => `/quality/inspections/${id}`,
  QUALITY_INSPECTION_NEW: "/quality/inspections/new",
  QUALITY_CRITERIA: "/quality/criteria",
  SHIPPING: "/shipping",
  SHIPPING_SHIPMENTS: "/shipping/shipments",
  SHIPPING_SHIPMENT_DETAIL: (id: string) => `/shipping/shipments/${id}`,
  SHIPPING_SHIPMENT_NEW: "/shipping/shipments/new",
...
export const CACHE_KEYS = {
  ...
  WORK_CENTER: (id: string) => ["manufacturing", "work-centers", id],
  BOMS: ["manufacturing", "bom"],
  BOM: (id: string) => ["manufacturing", "bom", id],
  BOM_EXPLODE: (id: string) => ["manufacturing", "bom", id, "explode"],
  WORK_ORDERS: ["manufacturing", "work-orders"],
  WORK_ORDER: (id: string) => ["manufacturing", "work-orders", id],
  QC_CHECKLISTS: ["quality", "checklists"],
  QC_CHECKLIST: (id: string) => ["quality", "checklists", id],
  ...
  SHIPPING_CARRIERS: ["shipping", "carriers"],
  SHIPPING_CARRIER: (id: string) => ["shipping", "carriers", id],
  SHIPPING_SHIPMENTS: ["shipping", "shipments"],
  SHIPPING_SHIPMENT: (id: string) => ["shipping", "shipments", id],
  SHIPPING_TRACKING: (num: string) => ["shipping", "tracking", num],
} as const;
